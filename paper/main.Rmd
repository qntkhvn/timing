...
This indicates that the snap timing appears to be relatively short across the considered motion plays.
...
As it turns out, among the considered random effects, the largest source variation is between quarterbacks when modeling the snap timing shape $\alpha$, as captured by $\hat \tau_q = 0.297$.
