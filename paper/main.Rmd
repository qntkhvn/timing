...
Note that our strategy to provide annotations for the motion types is similar to the approach in @dutta2020unsupervised for identifying defensive coverage types.
That is, we first extract features based on the high-resolution tracking data, before performing clustering to provide proper event annotations.
