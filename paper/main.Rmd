...
As mentioned in Section \ref{sec:model}, we now investigate the random effects in the mean parameter model for the two groups on offense: quarterbacks and motion players.
...
Hence, a quarterback can be consistent or variable with managing snap timing, but this does not necessarily depend on the duration of the snap timing itself on average.
