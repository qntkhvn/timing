...
The first is a 9-yard pass to WR Marquez Valdes-Scantling for a first down in the second quarter of Colts vs Chiefs in week 3.
The second is a 45-yard TD pass to WR JuJu Smith-Schuster in the fourth quarter against the 49ers in week 7.
In both plays, KC uses the same type of motion---glide, as the motion player (highlighted in gold) lines up in an outside wide alignment, then motions toward the inside, and the football is snapped when the player is about halfway to the center.

But these two plays differ in the time between start of motion and ball snap.
In the first play, the snap happens ~4 seconds after the motion from Travis Kelce begins, whereas in the second, the snap occurs within a half second of the motion from Mecole Hardman.
