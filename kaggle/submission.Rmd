...
title: |
  | Down, set, hut! Explaining variability in snap cadence on plays with motion
output: 
  html_document: 
    math_method: katex
...
Note that in our analysis, we only consider **plays with receivers in motion at snap and that are running a route**.
...
Note that there is considerable uncertainty in our estimates, as demonstrated by the rather wide credible intervals, which is unsurprising given our limited sample of motion plays. However, we still observe substantial differences in the credible intervals across this selection of QBs. For instance, despite his pay, Daniel Jones 95% credible interval does not overlap at all with the 95% credible intervals of the top five QBs.
...
On a personal note, QN failed to convince RY to name the metric _STRAIN (Patrick's version)_, where STRAIN stands for Snap Timing Rhythm and Adaptability INdex.