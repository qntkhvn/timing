...
Figure X is a scatterplot of the posterior mean and havoc rate for all passing plays in the considered nine-week data sample.
We observe a moderately strong, negative correlation ($r=-0.52$) between the quantities.
