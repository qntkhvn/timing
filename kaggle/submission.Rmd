...
We choose the optimal number of clusters using BIC (resulting in 10 clusters), and validate the cluster assignment results by visualizing the player motion trajectories in each cluster.
