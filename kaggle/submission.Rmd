...
We choose the optimal number of clusters using BIC, and validate the cluster assignment results by visualizing the player motion trajectories in each cluster.
