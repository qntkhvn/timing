...
In detail, we model the response $\delta_i > 0$ (motion-to-snap timing for play $i$) with a Gamma distribution, which is well-suited for a positive, continuous  like our case.
