...
\begin{align*}
  ...
  \alpha_q  &\sim \textsf{Normal}(\mu_{\alpha_q}, \sigma^2_{\alpha_q}) && \textrm{\small{\(\textrm{for quarterback}\)}} &q &= 1, \dots, Q \\
  \alpha_m  &\sim \textsf{Normal}(\mu_{\alpha_m}, \sigma^2_{\alpha_m}) && \textrm{\small{\(\textrm{for motion player}\)}} &m &= 1, \dots, M \\
  \alpha_d  &\sim \textsf{Normal}(\mu_{\alpha_d}, \sigma^2_{\alpha_d}) && \textrm{\small{\(\textrm{for defensive team}\)}} &d &= 1, \dots, D \\
\end{align*}
