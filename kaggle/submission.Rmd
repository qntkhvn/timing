...
We compute the displacement between the snapper and motion player at ball-snap in both sideline $(\textsf{B}_{\textsf{sideline}})$ and endzone $(\textsf{B}_{\textsf{endzone}})$ directions.
...
As a side note, the posterior mean for the shape random effect scarcely correlates with the rate of motion on all pass plays.
Additionally, there is a weak correlation between motion rate and havoc rate.
...
[[TODO: mention we did not consider running plays]]
