...
In this work, **we propose a multilevel modeling framework to assess a passer's ability to adapt and align the snap with their team's pre-snap motion, culminating in a novel metric for evaluating snap timing variability**.
...
## QB snap timing variability leaderboard
...
For each player, the posterior mean of the aforementioned distribution provides an estimate for their ability to maintain variability in snap timing, **with higher posterior means corresponding to greater variability in timing between motion and snap**.
...
## Comparison to rate of havoc events
...
Since neither of these task is the main focus of our work, we leave these explorations for the future.
